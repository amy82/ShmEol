...
#define ERR_BOARD_DEVICE_CHECK      (14)
...
{
    CRC_TYPE_CRC8_START,
    CRC_TYPE_CRC8_DEFAULT = 0, //polynomial 0x7  Initial 0x0  Xor 0x0
    CRC_TYPE_CRC8_SAE_J1850, //polynomial 0x1D  Initial 0xFF  Xor 0xFF
    CRC_TYPE_CRC8_SAE_J1850_ZERO, //polynomial 0x1D  Initial 0x0  Xor 0x0
    CRC_TYPE_CRC16_START = 10,
    CRC_TYPE_CRC16_CCIT_ZERO = 10, //polynomial 0x1021  Initial 0x0  Xor 0x0
    CRC_TYPE_CRC16_CCIT_FALSE, //polynomial 0x1021  Initial 0xFFFF  Xor 0x0
} CRCTYPE;
...
public:
    ...
    virtual int OpenBoardOnly(char cBoardIndex) = 0;
    ...
    virtual int WriteI2CMultiAddrBurst(unsigned short nSlaveAddr, unsigned short* nAddr, unsigned short nAddrByteCount, unsigned char* pData, unsigned short nWriteByteCount) = 0;

    virtual int ReadI2CMultiAddrBurst(unsigned short nSlaveAddr, unsigned short* nAddr, unsigned short nAddrByteCount, unsigned char* pData, unsigned short nReadByteCount) = 0;
    ...
    virtual int GetISPControl(unsigned short* nISPValue) = 0;
    ...
    virtual bool GetBrightestPoint(double& dX, double& dY, double* pBPData = NULL) = 0;

    virtual int SetBoardConfigForModelAPI(char cBoardIndex, const char* pszModelName) = 0;

    // CRC APIs
    virtual bool CalculateCRC(CRCTYPE eCRCType, int nDataLength, unsigned char* pData, unsigned char* retValue) = 0;
    ...
    virtual bool GetCatMultiRegister(unsigned char category, int nAddrLength, unsigned char* pAddr, int nDataLength, unsigned char* pData) = 0;
    ...
    virtual int GetFwCRC(unsigned char* retValue) = 0;
    virtual int GetSensorVersion(unsigned char* retValue) = 0;
    virtual int GetBuildDate(unsigned char* retValue) = 0;
    ...
    virtual bool SetCatMultiRegister(unsigned char category, int nAddrLength, unsigned char* pAddr, int nDataLength, unsigned char* pData) = 0;

    virtual bool SetAlpha(int nDataLength, unsigned char* pData) = 0;

    virtual bool SetWPEnable() = 0;
    virtual bool SetWPDisable() = 0;
    virtual bool SetHDRMode() = 0;
    virtual bool SetLinearMode() = 0;
