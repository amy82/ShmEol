...
#define SAMPLE_VID_LOT_PRECESS_DATA_START	40002
#define SAMPLE_VID_LOT_PRECESS_DATA_END		40097




static TCHAR* RCMD_LIST_NAME[14] = {
	//Common Remote Command
	_T("LGIT_CTRLSTATE_CHG_REQ"),			//0
	_T("LGIT_OP_CALL"),						//1
	_T("LGIT_SETCODE_OFFLINE_REASON"),		//2 x
	_T("LGIT_SETCODE_IDLE_REASON"),			//3
	//Process Operation / Recipe Management Remote Command
	_T("LGIT_SETCODE_MATERIAL_EXCHANGE") ,	//4
	_T("LGIT_SETCODE_MODEL_LIST") ,			//5
	_T("LGIT_PP_SELECT") ,					//6
	_T("LGIT_LOT_ID_FAIL"),					//7
	_T("LGIT_PP_UPLOAD_CONFIRM"),			//8
	_T("LGIT_PP_UPLOAD_FAIL"),				//9
	_T("LGIT_LOT_START"),					//10
	_T("LGIT_MATERIAL_ID_CONFIRM"),			//11
	_T("LGIT_MATERIAL_ID_FAIL"),			//12
	_T("LGIT_PAUSE")						//13
};
//-------------------------------------------------------------------------------------------------------------
//
...
//
//-------------------------------------------------------------------------------------------------------------
//01.Spec 11 Page에서 확인
//1. Equipment-Offline - Operator에 의해 OFF-LINE으로 전환된 상태
//2. Attempt Online		- 설비는 이 State가 되자마자 Host로 S1,F1을 Host로 전송한다. 
	//이때 작업자에 의해 ON-LINE/OFF-LINE로 전환이 되면 안된다.
//3. Host Offline		-ON-LINE 전환 실패시 Default Offline Sub Stat가 HOST OFF-LINE 일 경우나 Host에서 OFF-LINE 전환되었을 때의 상태이다.
//
//ON-LINE
//4. Online-Local - 설비는 Operator 에 의해 운영이 된다.
//5. Online-Remote - Host에서 Access 가능
...
//1. INIT	- 설비 System이 Initialization 을 수행하는 상태
//2. IDLE	- 초기화 후 또는 Run작업을 마친 후의 상태
//3. SETUP	- 공정 진행을 위한 모든 외부적인 조건이 만족된 상태
//4. READY	- 작업자의 Start 명령만을 남겨두고 있는 상태
//5. EXECUTING	- 설비가 해당 Process Program을 자동으로 수행중이다. 정상 종료하면 IDEL 상태로 전환
//6. PAUSE - 일시 정지하여 어떤 명령을 기다리고 있는 상태.
...
#define SAMPLE_DD_PNAME _T("PNAME") // Parameter Name ≤16 characters.
...
//const int g_LotApdInfoCount = 98;
static TCHAR* LOT_APD_INFO[g_LotApdInfoCount] =
{
	_T("BARCODE"),
	_T("SENSOR_SERIAL_ID"),
	_T("CURRENT"),
	...
	_T("SFR_7F_BR_V"),
	_T("SFR_0F_AVERAGE"),
	_T("SFR_4F_LT_AVERAGE"),
	_T("SFR_4F_RT_AVERAGE"),
	_T("SFR_4F_LB_AVERAGE"),
	_T("SFR_4F_RB_AVERAGE"),
	_T("SFR_7F_LT_AVERAGE"),
	_T("SFR_7F_RT_AVERAGE"),
	_T("SFR_7F_LB_AVERAGE"),
	_T("SFR_7F_RB_AVERAGE"),
	_T("SFR_4F_DIFF"),
	_T("SFR_7F_DIFF"),
	_T("OC_X"),
	_T("OC_Y"),
	...
	_T("BLEMISH_FPF"),
	_T("BLEMISH_YMEAN"),
	_T("BLEMISH_LCB_MAX_VALUE_CENTER"),
	_T("BLEMISH_LCB_MAX_VALUE_EDGE"),
	_T("BLEMISH_LCB_MAX_VALUE_CORNER"),
	_T("BLEMISH_FDF_MAX_VALUE_CENTER"),
	_T("BLEMISH_FDF_MAX_VALUE_EDGE"),
	_T("BLEMISH_FDF_MAX_VALUE_CORNER"),
	_T("BLEMISH_YMEAN_MAX_VALUE_CENTER"),
	_T("BLEMISH_YMEAN_MAX_VALUE_EDGE"),
	_T("BLEMISH_YMEAN_MAX_VALUE_CORNER"),
	_T("RI_DIFF"),
	...
	_T("RI_CONER4"),
	_T("RI_CONER_MIN"),
	_T("COLORREPRODUCTION_ROI1"),
	_T("COLORREPRODUCTION_ROI2"),
	_T("COLORREPRODUCTION_ROI3"),
	_T("COLORREPRODUCTION_ROI4"),
	_T("SATURATION_CHART_0F"),
	_T("SATURATION_CHART_4F_LT"),
	_T("SATURATION_CHART_4F_RT"),
	_T("SATURATION_CHART_4F_BL"),
	_T("SATURATION_CHART_4F_BR"),
	_T("SATURATION_CHART_7F_LT"),
	_T("SATURATION_CHART_7F_RT"),
	_T("SATURATION_CHART_7F_BL"),
	_T("SATURATION_CHART_7F_BR"),
	_T("SATURATION_OC"),
	_T("NOR_FLASH_MEMORY_ISP_VERSION"),
	_T("NOR_FLASH_MEMORY_ISP_MODEL"),
	_T("ERROR_FLAG_CHECK_IMAGE_SENSOR"),
	_T("ERROR_FLAG_CHECK_PMIC"),
	_T("ERROR_FLAG_CHECK_SERIALIZER1"),
	_T("ERROR_FLAG_CHECK_SERIALIZER2"),
	_T("RGB_TOP_CHART_LT"),
	_T("RGB_TOP_CHART_LB"),
	_T("RGB_TOP_CHART_RB"),
	_T("RGB_TOP_CHART_RT"),
	_T("RGB_SIDE_CHART_LT"),
	_T("RGB_SIDE_CHART_LB"),
	_T("RGB_SIDE_CHART_RT"),
	_T("RGB_SIDE_CHART_RB"),
	_T("RGB_TOP_CHART_AVERAGE"),
	_T("RGB_OC_CENTER"),
	_T("SENSOR_VOLTAGE_AVDD"),
	_T("SENSOR_VOLTAGE_OVDD"),
	_T("SENSOR_VOLTAGE_DVDD"),
	_T("FW_ORIGINAL_FILE"),
	_T("FW_JUDGE"),
	_T("LASER_TILT_X"),
	_T("LASER_TILT_Y"),
